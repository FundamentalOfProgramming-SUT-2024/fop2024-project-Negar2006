...
void connectDoors(Level *level) {
    ...
    //     connectedDoors += 2; 
    // }
	pathFind(&level->rooms[0]->doors[1]->position,&level->rooms[1]->doors[0]->position);
	pathFind(&level->rooms[1]->doors[1]->position,&level->rooms[2]->doors[0]->position);
	pathFind(&level->rooms[2]->doors[1]->position,&level->rooms[3]->doors[1]->position);
	pathFind(&level->rooms[3]->doors[0]->position,&level->rooms[4]->doors[1]->position);
	pathFind(&level->rooms[4]->doors[0]->position,&level->rooms[5]->doors[1]->position);
	pathFind(&level->rooms[5]->doors[0]->position,&level->rooms[0]->doors[0]->position);
}
Player * playerSetUp() {
	Player * newPlayer;
